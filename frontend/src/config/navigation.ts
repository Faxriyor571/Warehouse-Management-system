import { Boxes, Download, LayoutDashboard, Ruler, Store, Tag, Truck, Users, type LucideIcon } from "lucide-react";
...
export const navSections: NavSection[] = [
  ...
  },
  {
    id: "operations",
    label: "OPERATSIYALAR",
    items: [{ id: "stock-in", title: "Kirim", href: "/stock-in", icon: Download }],
  },
];
